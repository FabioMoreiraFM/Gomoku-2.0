...
class TestControleEncadeamentoMethods(unittest.TestCase):
    ...
    def test_encadeamento_tamanho_1(self):
        ...
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [2,3])
    ...
    def test_encadeamento_tamanho_5(self):
        ...
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [0,0])
        
        self.tabuleiro.inserir_peca([0,1], Jogador.ADVERSARIO_1)
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [0,1])
        
        self.tabuleiro.inserir_peca([0,2], Jogador.ADVERSARIO_1)
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [0,2])
        
        self.tabuleiro.inserir_peca([0,3], Jogador.ADVERSARIO_1)
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [0,3])
        
        self.tabuleiro.inserir_peca([0,4], Jogador.ADVERSARIO_1)
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [0,4])
    ...
    def test_encadeamento_tamanho_maior_5(self):
        ...
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [3,0])
        
        self.tabuleiro.inserir_peca([3,1], Jogador.ADVERSARIO_1)
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [3,1])
        
        self.tabuleiro.inserir_peca([3,2], Jogador.ADVERSARIO_1)
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [3,2])
        
        self.tabuleiro.inserir_peca([3,3], Jogador.ADVERSARIO_1)
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [3,3])
        
        self.tabuleiro.inserir_peca([3,4], Jogador.ADVERSARIO_1)
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [3,4])

        self.tabuleiro.inserir_peca([3,5], Jogador.ADVERSARIO_1)
        self.controle.atualiza(self.tabuleiro.get_tabuleiro(), [3,5])
